<template>
    <div id="sendM">
        <div class="sendM-top"></div>
        <div class="sendM-container">
            <div class="sendM-way">
                <div><img src="src/assets/img/part-three/receiver.png" alt=""><span>收信件</span></div>
                <div class="sendM-select"><span>已发送</span></div>
            </div>
