<template>
    <div class="background">
        <div class="up">
            ...
            <p>
                登录，才能给你更好的<br/>
                Login, to give you better
            </p>
        </div>
        <div class="down">
            <div class="phone">
                <span class="span1">
                    <img class="img1" src="../../img/phone.png">
                </span>
            ...
            <div class="password">
                <span class="span4">
                    <img class="img3" src="../../img/password.png">
                </span>
...
<style lang="scss" scoped>
    ...
    *{
    ...
    .down .phone .span2{
        ...
        margin-top: px2rem(107.8018px);
        position: absolute;
        background-color: transparent;
    }
    .down .password .span2{
        margin-left: px2rem(-36.4063px);
        margin-top: px2rem(51.8818px);
        position: absolute;
        background-color: transparent;
    }
    .down .password .span4{
    ...
    .down .span3{
        ...
        font-size: px2rem(24px);
        color: #A5A5A5;
        margin:px2rem(119px) px2rem(-65px);
        position: absolute;
        text-align:center;
        background-color: transparent;
    }
